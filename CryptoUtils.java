...
public class CryptoUtils {
  ...
  // Metodo ausiliario privato per generare una SecretKeySpec dalla chiave
  // fornita.
  public static SecretKeySpec getKey(String myKey) throws Exception {
    ...
    // Creazione di una nuova SecretKeySpec per AES utilizzando l'array di byte
    // ridimensionato.
  ...
  public static String decrypt(String encryptedData, String key) throws Exception {
    ...
    // Decriptazione dei dati dalla loro forma Base64 e ritorno alla forma
    // originale.
